...
namespace Turbo.Runtime
{
    public interface ITHPItems : IEnumerable
    {
        ...
        ITHPItem this[string name] { [PermissionSet(SecurityAction.LinkDemand, Name = "FullTrust")] get; }

        ITHPItem this[int index] { [PermissionSet(SecurityAction.LinkDemand, Name = "FullTrust")] get; }
