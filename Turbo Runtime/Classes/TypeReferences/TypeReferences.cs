...
namespace Turbo.Runtime
{
    internal sealed class TypeReferences
    {
        ...
        internal ConstructorInfo tFunctionAttributeConstructor => TFunctionAttribute.GetConstructor(new[]
        {
            TFunctionAttributeEnum
        });

        internal ConstructorInfo tLocalFieldConstructor => TLocalField.GetConstructor(new[]
        {
            String,
            RuntimeTypeHandle,
            Int32
        ...
        internal MethodInfo setIndexedPropertyValueStaticMethod
            => LateBinding.GetMethod("SetIndexedPropertyValueStatic");
        ...
        internal ConstructorInfo thpEngineConstructor => THPMainEngine.GetConstructor(new Type[0]);
        ...
        internal MethodInfo getOriginalObjectConstructorMethod
            => THPMainEngine.GetMethod("GetOriginalObjectConstructor");

        internal MethodInfo getOriginalRegExpConstructorMethod
            => THPMainEngine.GetMethod("GetOriginalRegExpConstructor");
        ...
        internal MethodInfo getLenientGlobalObjectMethod
            => THPMainEngine.GetProperty("LenientGlobalObject").GetGetMethod();
        ...
        internal static MethodInfo getCurrentMethod
            => IEnumerator.GetProperty("Current", Type.EmptyTypes).GetGetMethod();
        ...
        internal static ConstructorInfo debuggerHiddenAttributeCtor
            => DebuggerHiddenAttribute.GetConstructor(new Type[0]);
        ...
        internal bool InReferenceContext(Type type)
        {
            ...
            return assembly.ReflectionOnly || assembly != typeof (TypeReferences).Assembly ||
                   !TurboReferenceModule.Assembly.ReflectionOnly;
        }
        ...
        internal bool InReferenceContext(IReflect ireflect)
            => !(ireflect is Type) || InReferenceContext((Type) ireflect);
        ...
        internal static FieldInfo ToExecutionContext(FieldInfo field)
            => (FieldInfo) MapMemberInfoToExecutionContext(field);
