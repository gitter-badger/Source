...
namespace Turbo.Runtime
{
    internal sealed class TGlobalField : TVariableField
    {
        ...
        internal TGlobalField(ScriptObject obj, string name, object value, FieldAttributes attributeFlags)
            ...
            CultureInfo culture)
        {
            ...
            {
                if (!(this.value is FunctionObject) || !(value is FunctionObject) ||
                    !Name.Equals(((FunctionObject) value).name))
