...
namespace Turbo.Runtime
{
    ...
    public class TurboException : ApplicationException, ITHPFullErrorInfo
    {
            ...
            get
            {
                ...
                if (context != null)
                {
                    ...
                    if (jSError <= TError.NotDeletable)
                    {
                        ...
                        else if (jSError != TError.AmbiguousBindingBecauseOfWith &&
                                 jSError != TError.AmbiguousBindingBecauseOfEval && jSError != TError.NotDeletable)
                        {
                            goto IL_317;
                        }
                    }
                    ...
                    else if (jSError != TError.ObjectExpected && jSError != TError.UndefinedIdentifier &&
                             jSError != TError.AssignmentToReadOnly)
                    {
                        goto IL_317;
                    }
                    return Localize(text, context.GetCode(), culture);
        ...
        internal TurboException(TError errorNumber, Context context)
        {
            ...
            unchecked
            {
                code = (HResult = (int) ((ulong) -2146828288 + (ulong) ((long) errorNumber)));
            }
        }
        ...
        internal static string Localize(string key, string context, CultureInfo culture)
        {
            ...
            {
                var @string =
                    new ResourceManager("Turbo.Runtime", typeof (TurboException).Module.Assembly).GetString(key, culture);
                if (@string != null)
                {
