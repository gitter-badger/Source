...
namespace Turbo.Runtime
{
	public class Relational : BinaryOp
	{
		...
		internal Relational(Context context, AST operand1, AST operand2, TToken operatorTok) : base(context, operand1, operand2, operatorTok)
		{
		}
	    ...
	    public static double TurboCompare(object v1, object v2)
		{
            ...
            return TurboCompare2(v1, v2, Convert.GetIConvertible(v1), Convert.GetIConvertible(v2), Convert.GetTypeCode(v1, Convert.GetIConvertible(v1)), Convert.GetTypeCode(v2, Convert.GetIConvertible(v2)));
		}

		private static double TurboCompare2(object v1, object v2, IConvertible ic1, IConvertible ic2, TypeCode t1, TypeCode t2)
		{
	    ...
	    internal override void TranslateToILInitializer(ILGenerator il)
	    {
	        ...
	        if ((type1.IsPrimitive || Typeob.TObject.IsAssignableFrom(type1)) && (loctype.IsPrimitive || Typeob.TObject.IsAssignableFrom(loctype)))
	        {
	            return;
	        }
