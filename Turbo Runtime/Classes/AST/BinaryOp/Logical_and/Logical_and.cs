...
namespace Turbo.Runtime
{
	internal sealed class Logical_and : BinaryOp
	{
		...
		internal override object Evaluate()
		{
			...
			{
				type = obj.GetType();
				methodInfo = type.GetMethod("op_False", BindingFlags.Static | BindingFlags.Public | BindingFlags.ExactBinding, null, new[]
				{
					type
				}, null);
		    ...
		    var methodInfo2 = type.GetMethod("op_BitwiseAnd", BindingFlags.Static | BindingFlags.Public | BindingFlags.ExactBinding, null, new[]
		    {
		        type,
		        type
		    }, null);
		...
		internal override void TranslateToIL(ILGenerator il, Type rtype)
		{
			...
			var methodInfo = type.GetMethod("op_False", BindingFlags.Static | BindingFlags.Public | BindingFlags.ExactBinding, null, new[]
			{
				type
			}, null);
			if (methodInfo == null || (methodInfo.Attributes & MethodAttributes.SpecialName) == MethodAttributes.PrivateScope || methodInfo.ReturnType != Typeob.Boolean)
			...
			if (methodInfo != null)
			{
				methodInfo2 = type.GetMethod("op_BitwiseAnd", BindingFlags.Static | BindingFlags.Public | BindingFlags.ExactBinding, null, new[]
				{
					type,
					type
				}, null);
