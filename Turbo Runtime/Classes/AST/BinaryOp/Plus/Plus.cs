...
namespace Turbo.Runtime
{
	public sealed class Plus : BinaryOp
	{
		...
		internal Plus(Context context, AST operand1, AST operand2) : base(context, operand1, operand2, TToken.FirstBinaryOp)
		{
		}
		...
		private object EvaluatePlus2(object v1, object v2)
		{
			...
			case TypeCode.Char:
			{
				...
				case TypeCode.Single:
				case TypeCode.Double:
					return checked((char)((int)Convert.CheckIfDoubleIsInteger((double)DoOp(num2, iConvertible2.ToDouble(null)))));
				}
				break;
			}
			case TypeCode.UInt32:
			...
			case TypeCode.Int64:
			{
				...
				case TypeCode.UInt64:
					return num5 >= 0L ? DoOp((ulong)num5, iConvertible2.ToUInt64(null)) : DoOp(num5, iConvertible2.ToDouble(null));
				    case TypeCode.Single:
				case TypeCode.Double:
