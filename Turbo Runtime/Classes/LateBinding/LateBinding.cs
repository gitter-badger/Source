...
namespace Turbo.Runtime
{
	public sealed class LateBinding
	{
		...
		public object Call(object[] arguments, bool construct, bool brackets, THPMainEngine engine)
		{
			...
			{
				result = name == null 
                    ? CallValue(obj, arguments, construct, brackets, engine, ((IActivationObject)engine.ScriptObjectStackTop()).GetDefaultThisObject(), TBinder.ob, null, null) 
		...
		[DebuggerHidden, DebuggerStepThrough]
		internal object Call(Binder binder, object[] arguments, ParameterModifier[] modifiers, CultureInfo culture, string[] namedParameters, bool construct, bool brackets, THPMainEngine engine)
		{
			...
			if (obj is ScriptObject || obj is GlobalObject)
			{
				if (obj is WithObject)
				{
					...
					{
						var iRForObjectThatRequiresInvokeMember = GetIRForObjectThatRequiresInvokeMember(contained_object, THPMainEngine.executeForJSEE);
				...
				{
					return CallValue(((FieldInfo)memberInfo).GetValue(obj), arguments, construct, brackets, engine, obj, TBinder.ob, null, null);
				}
				if (memberInfo is PropertyInfo && !(memberInfo is TProperty))
				{
				    if (brackets)
				        return CallValue(TProperty.GetValue((PropertyInfo) memberInfo, obj, null), arguments, construct, true,
				    ...
				    if (jSWrappedPropertyAndMethod == null)
				        return CallValue(TProperty.GetValue((PropertyInfo) memberInfo, obj, null), arguments, construct, false,
				            engine, obj, TBinder.ob, null, null);
				    var options = (arguments == null || arguments.Length == 0) ? BindingFlags.InvokeMethod : (BindingFlags.InvokeMethod | BindingFlags.GetProperty);
				...
				if (memberInfo is MethodInfo)
				{
					...
					{
					    return construct ? ((TMethod)memberInfo).Construct(arguments) : ((TMethod)memberInfo).Invoke(obj, obj, BindingFlags.Default, TBinder.ob, arguments, null);
					}
				    ...
				    {
				        return CallValue(((MethodInfo)memberInfo).Invoke(obj, null), arguments, construct, false, engine, obj, TBinder.ob, null, null);
				    }
				    if (!(obj is ClassScope))
				    {
				        if (!CustomAttribute.IsDefined(memberInfo, typeof (TFunctionAttribute), false))
				            return CallValue(new BuiltinFunction(obj, (MethodInfo) memberInfo), arguments, construct, false, engine,
				                obj, TBinder.ob, null, null);
				        var fieldInfo = SelectMember(last_members) as FieldInfo;
				        if (fieldInfo == null)
				            return CallValue(new BuiltinFunction(obj, (MethodInfo) memberInfo), arguments, construct, false,
				                engine, obj, TBinder.ob, null, null);
				        var value = obj;
				        if (!(value is Closure))
				        {
			...
			if (!construct && memberInfo is PropertyInfo)
			{
				...
				if (((PropertyInfo)memberInfo).GetIndexParameters().Length == 0)
				{
					...
					if (propertyType == typeof(object))
					{
						...
						if (getMethod != null)
						{
							return CallValue(getMethod.Invoke(obj, null), arguments, false, brackets, engine, obj, TBinder.ob, null, null);
						}
					}
					...
					if (defaultMembers != null && defaultMembers.Length != 0)
					{
						...
						if (getMethod2 != null)
						{
							...
							return CallOneOfTheMembers(defaultMembers, arguments, false, thisob, culture, namedParameters, engine);
						}
					}
				}
			}
			...
			{
				bool flag;
				var result = CallOneOfTheMembers(last_members, arguments, construct, obj, culture, namedParameters, engine, out flag);
				if (flag)
				{
					return result;
				}
			}
			var iRForObjectThatRequiresInvokeMember2 = GetIRForObjectThatRequiresInvokeMember(obj, THPMainEngine.executeForJSEE);
		...
		[DebuggerHidden, DebuggerStepThrough]
		private static object CallCOMObject(IReflect ir, string name, object ob, Binder binder, object[] arguments, ParameterModifier[] modifiers, CultureInfo culture, string[] namedParameters, bool construct, bool brackets, THPMainEngine engine)
		{
			object result;
			try
			{
				try
				{
					...
					var bindingFlags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.OptionalParamBinding;
					if (construct)
					{
						result = ir.InvokeMember(name, bindingFlags | BindingFlags.CreateInstance, binder, ob, arguments, modifiers, culture, namedParameters);
					}
					else
					{
						if (brackets)
						{
							try
							{
								result = ir.InvokeMember(name, bindingFlags | BindingFlags.GetProperty | BindingFlags.GetField, binder, ob, arguments, modifiers, culture, namedParameters);
								return result;
							}
							catch (TargetInvocationException)
							{
								var obj = ir.InvokeMember(name, bindingFlags | BindingFlags.GetProperty | BindingFlags.GetField, binder, ob, new object[0], modifiers, culture, new string[0]);
								result = CallValue(obj, arguments, false, true, engine, obj, binder, culture, namedParameters);
								return result;
							}
						}
						...
						result = ir.InvokeMember(name, bindingFlags, binder, ob, arguments, modifiers, culture, namedParameters);
					}
				}
		...
		[DebuggerHidden, DebuggerStepThrough]
		internal static object CallOneOfTheMembers(MemberInfo[] members, object[] arguments, bool construct, object thisob, CultureInfo culture, string[] namedParameters, THPMainEngine engine)
		{
			bool flag;
			var arg_1C_0 = CallOneOfTheMembers(members, arguments, construct, thisob, culture, namedParameters, engine, out flag);
			if (!flag)
			{
		...
		[DebuggerHidden, DebuggerStepThrough]
		internal static object CallOneOfTheMembers(MemberInfo[] members, object[] arguments, bool construct, object thisob, CultureInfo culture, string[] namedParameters, THPMainEngine engine, out bool memberCalled)
		{
			memberCalled = true;
			if (construct)
			{
				var constructorInfo = TBinder.SelectConstructor(Runtime.TypeRefs, members, ref arguments, namedParameters);
				if (constructorInfo != null)
				{
				    ...
				    var obj = jSConstructor != null ? jSConstructor.Construct(thisob, LickArgumentsIntoShape(constructorInfo.GetParameters(), arguments, TBinder.ob, culture)) : constructorInfo.Invoke(BindingFlags.SuppressChangeType, null, LickArgumentsIntoShape(constructorInfo.GetParameters(), arguments, TBinder.ob, culture), null);
			...
			else
			{
				...
				if (methodInfo != null)
				{
					...
					{
					    var builtinFunction = ((TFunctionAttribute)CustomAttribute.GetCustomAttributes(methodInfo, typeof(TFunctionAttribute), false)[0]).builtinFunction;
					    if (builtinFunction == TBuiltin.None)
					        return CallValue(new BuiltinFunction(thisob, methodInfo), arguments, false, false, engine, thisob,
		...
		[DebuggerHidden, DebuggerStepThrough]
		public static object CallValue(object thisob, object val, object[] arguments, bool construct, bool brackets, THPMainEngine engine)
		{
			object result;
			try
			{
		...
		[DebuggerHidden, DebuggerStepThrough]
		public static object CallValue2(object val, object thisob, object[] arguments, bool construct, bool brackets, THPMainEngine engine)
		{
			object result;
			try
			{
	    ...
	    [DebuggerHidden, DebuggerStepThrough]
	    internal static object CallValue(object val, object[] arguments, bool construct, bool brackets, THPMainEngine engine, object thisob, Binder binder, CultureInfo culture, string[] namedParameters)
	    {
	        while (true)
	        {
	            if (construct)
	            {
	                ...
	                if (val is ClassScope)
	                {
	                    ...
	                    var expr_17F = (TObject) CallOneOfTheMembers(((ClassScope) val).constructors, arguments, true, thisob, culture, namedParameters, engine);
	                ...
	                if (val is Type)
	                {
	                    ...
	                    var obj3 = constructors.Length == 0 ? Activator.CreateInstance(type, BindingFlags.Default, TBinder.ob, arguments, null) : CallOneOfTheMembers(constructors, arguments, true, thisob, culture, namedParameters, engine);
	                ...
	                if (THPMainEngine.executeForJSEE && val is IDebuggerObject)
	                {
	                    ...
	                    return expr_25F.InvokeMember(string.Empty, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.CreateInstance | BindingFlags.OptionalParamBinding, binder, thisob, arguments, null, culture, namedParameters);
	                }
	            }
	            if (brackets)
	            {
	            ...
	            else
	            {
	                ...
	                if (THPMainEngine.executeForJSEE && val is IDebuggerObject)
	                {
	                    ...
	                    return CallCOMObject(expr_372, string.Empty, val, binder, array3, null, culture, array4, false, false, engine);
	                }
	                if (val is ClassScope)
	                {
	                ...
	                {
	                    return CallOneOfTheMembers((MemberInfo[]) val, arguments, construct, thisob, culture, namedParameters, engine);
	                }
	            }
	            ...
	            var iRForObjectThatRequiresInvokeMember = GetIRForObjectThatRequiresInvokeMember(val, THPMainEngine.executeForJSEE);
	            if (iRForObjectThatRequiresInvokeMember != null)
	            {
	                if (brackets)
	                {
	                    ...
	                    return CallCOMObject(iRForObjectThatRequiresInvokeMember, text, val, binder, null, null, culture, namedParameters, false, true, engine);
	                }
	                if (!(val is IReflect))
	                {
	                    return CallCOMObject(iRForObjectThatRequiresInvokeMember, string.Empty, val, binder, arguments, null, culture, namedParameters, false, false, engine);
	                }
	                ...
	                return CallCOMObject(iRForObjectThatRequiresInvokeMember, "[DISPID=0]", val, binder, array6, null, culture, array7, false, false, engine);
	            }
		...
		public static bool DeleteMember(object obj, string name)
		{
			...
			if (!(obj is IDictionary))
			{
				...
				var method = TypeReflector.GetTypeReflectorFor(type).GetMethod("op_Delete", BindingFlags.Static | BindingFlags.Public | BindingFlags.ExactBinding, null, new[]
				{
					type,
					typeof(object[])
				}, null);
				return !(method == null) && (method.Attributes & MethodAttributes.SpecialName) != MethodAttributes.PrivateScope && !(method.ReturnType != typeof(bool)) && (bool)method.Invoke(null, new[]
				{
					obj,
					new object[]
					{
		...
		internal static object GetMemberValue(object obj, string name, MemberInfo member, MemberInfo[] members)
		{
			...
			if (members != null && members.Length != 0)
			{
			    ...
			    if (declaringType == typeof(GlobalObject) || (declaringType != null && declaringType != typeof(StringObject) && declaringType != typeof(NumberObject) && declaringType != typeof(BooleanObject) && declaringType.IsSubclassOf(typeof(TObject))))
			    {
			...
			if (!(obj is Namespace))
			{
			    ...
			    try
			    {
			        var result = iRForObjectThatRequiresInvokeMember.InvokeMember(name, BindingFlags.Instance | BindingFlags.Public | BindingFlags.GetField | BindingFlags.GetProperty | BindingFlags.OptionalParamBinding, TBinder.ob, obj, null, null, null, null);
			        return result;
			    }
			    catch (MissingMemberException)
			    {
		...
		internal static object GetValueAtIndex(object obj, ulong index)
		{
			if (!(obj is ScriptObject))
			{
				while (!(obj is IList))
				{
					...
					var defaultPropertyForArrayIndex = TBinder.GetDefaultPropertyForArrayIndex(type, (int)index, null, false);
		...
		private static object[] LickArgumentsIntoShape(IReadOnlyList<ParameterInfo> pars, object[] arguments, Binder binder, CultureInfo culture)
		{
			if (arguments == null)
			{
				return null;
			...
			else
			{
				...
				if (reflect != null)
				{
					try
					{
						...
						array2[num - 1] = value;
						reflect.InvokeMember(string.Empty, BindingFlags.Instance | BindingFlags.Public | BindingFlags.SetField | BindingFlags.SetProperty | BindingFlags.OptionalParamBinding, TBinder.ob, ob, array2, null, null, null);
						return;
					}
					catch (MissingMemberException)
					{
			    ...
			    if (defaultMembers == null || defaultMembers.Length == 0) throw new TurboException(TError.OLENoPropOrMethod);
		...
		internal void SetIndexedPropertyValue(object[] arguments, object value)
		{
			...
			var iRForObjectThatRequiresInvokeMember = GetIRForObjectThatRequiresInvokeMember(obj, checkForDebugger, typeCode);
			if (iRForObjectThatRequiresInvokeMember != null)
			{
				var num = arguments.Length + 1;
				...
				array[num - 1] = value;
				iRForObjectThatRequiresInvokeMember.InvokeMember(name, BindingFlags.Instance | BindingFlags.Public | BindingFlags.SetField | BindingFlags.SetProperty | BindingFlags.OptionalParamBinding, TBinder.ob, obj, array, null, null, null);
				return;
			}
			var value2 = GetValue();
		...
		public static void SetIndexedPropertyValueStatic(object obj, object[] arguments, object value)
		{
			...
			else
			{
				...
				if (iRForObjectThatRequiresInvokeMember != null)
				{
					...
					iRForObjectThatRequiresInvokeMember.InvokeMember(text, BindingFlags.Instance | BindingFlags.Public | BindingFlags.SetField | BindingFlags.SetProperty | BindingFlags.OptionalParamBinding, TBinder.ob, obj, new[]
					{
						value
					}, null, null, null);
					return;
		...
		internal static void SetMemberValue(object obj, string name, object value, MemberInfo member)
		{
			...
			if (iRForObjectThatRequiresInvokeMember != null)
			{
				try
				{
					...
					const BindingFlags invokeAttr = BindingFlags.Instance | BindingFlags.Public | BindingFlags.SetField | BindingFlags.SetProperty | BindingFlags.OptionalParamBinding;
					iRForObjectThatRequiresInvokeMember.InvokeMember(name, invokeAttr, TBinder.ob, obj, args, null, null, null);
					return;
				}
				catch (MissingMemberException)
				{
		...
		internal static void SetValueAtIndex(object obj, ulong index, object value)
		{
			...
			else
			{
				while (!(obj is IList))
				{
					...
					var defaultPropertyForArrayIndex = TBinder.GetDefaultPropertyForArrayIndex(type, (int)index, null, true);
