...
namespace Turbo.Runtime
{
    public class LenientObjectPrototype : ObjectPrototype
    {
        ...
        internal void Initialize(LenientFunctionPrototype funcprot)
        {
            ...
            hasOwnProperty = new BuiltinFunction("hasOwnProperty", this, typeFromHandle.GetMethod("hasOwnProperty"),
                funcprot);
            isPrototypeOf = new BuiltinFunction("isPrototypeOf", this, typeFromHandle.GetMethod("isPrototypeOf"),
                funcprot);
            propertyIsEnumerable = new BuiltinFunction("propertyIsEnumerable", this,
                typeFromHandle.GetMethod("propertyIsEnumerable"), funcprot);
